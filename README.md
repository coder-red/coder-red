...
I build production-oriented AI systems with a focus on fraud detection, backend infrastructure, and agent-based decision workflows.

- 🔭 Currently building: An end-to-end fraud detection system combining ML models, FastAPI APIs, PostgreSQL, and agent-driven decision logic (LangGraph).
...
- 📫 Contact: Mohammed.Ds.Ml01@gmail.com
